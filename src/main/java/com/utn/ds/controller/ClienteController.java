...
import com.utn.ds.repository.ClienteRepository;
...
public class ClienteController {
    ...
    @GetMapping("/clientes")
    public ResponseEntity<List<Cliente>> getAllClientes(@RequestParam(required = false) String descripcion) {
        try {
    ...
    public ResponseEntity<Cliente> updateCliente(@PathVariable("id") long id, @RequestBody Cliente cliente) {
        ...
        if (clienteData.isPresent()) {
            ...
            _cliente.setCuil(cliente.getCuil());
